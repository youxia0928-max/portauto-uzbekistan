          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="pt-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  >
                    <div className="w-14 h-14 bg-blue-500 rounded-full flex items-center justify-center hover:scale-110 transition-transform">
                  ...
                  <a 
                    ...
                    className="group flex flex-col items-center gap-2"
                  >
                    <div className="w-14 h-14 bg-green-500 rounded-full flex items-center justify-center hover:scale-110 transition-transform">
                      <svg className="w-7 h-7 text-white" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <a 
                    ...
                    className="group flex flex-col items-center gap-2"
                  >
                    <div className="w-14 h-14 bg-blue-600 rounded-full flex items-center justify-center hover:scale-110 transition-transform">
                      <svg className="w-7 h-7 text-white" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              <h3 className="font-bold text-slate-900 mb-6 text-lg">
                Оставить заявку / Leave a Request / 填写表单
              </h3>
              ...
              {submitted ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-lg font-medium text-slate-900">Спасибо! / Thank you! / 谢谢！</p>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    <input
                      ...
                      placeholder="Ваше имя / Your name / 您的姓名"
                  ...
                  <div>
                    <input
                      ...
                      onChange={handleChange}
                      placeholder="Ваш телефон / Your phone / 您的电话"
                      className="w-full px-4 py-3 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      required
                    />
                  </div>
                  ...
                  <div>
                    <textarea
                      ...
                      onChange={handleChange}
                      placeholder="Ваше сообщение / Your message / 您的留言"
                      rows={4}
