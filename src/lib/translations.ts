...
export const translations = {
  ru: {
    ...
    about_subtitle: 'ОПИРАЯСЬ НА ГЛОБАЛЬНУЮ ЦЕПОЧКУ ПОСТАВОК, МЫ БЕСШОВНО СВЯЗЫВАЕМ ВАС С ЛУЧШИМИ АВТОМОБИЛЬНЫМИ РЕСУРСАМИ МИРА —— ДОБРО ПОЖАЛОВАТЬ В PORTAUTO UZBEKISTAN. СНИМАЯ БАРЬЕРЫ, ДОСТАВЛЯЕМ ЛУЧШИЕ АВТОМОБИЛИ СО ВСЕГО МИРА ПРЯМО В ТАШКЕНТ.',
    mission: 'НАША МИССИЯ',
    mission_text: 'НАШЕ ОСНОВНОЕ КОНКУРЕНТНОЕ ПРЕИМУЩЕСТВО ЗАКЛЮЧАЕТСЯ В НАШЕЙ СПОСОБНОСТИ ТОЧНО ОПРЕДЕЛЯТЬ ВАШИ КЛЮЧЕВЫЕ БОЛЕВЫЕ ТОЧКИ НА ПРОТЯЖЕНИИ ВСЕГО ПРОЦЕССА ЗАКУПКИ АВТОМОБИЛЕЙ, ИХ ТРАНСПОРТИРОВКИ И ПРОДАЖИ НА МЕСТЕ.',
    ...
    step1_process: 'ПОЛУЧИТЬ ПРЕДЛОЖЕНИЕ',
