        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex gap-8">
              {/* Image */}
              <div className="relative h-[450px] w-2/3 rounded-3xl overflow-hidden shadow-[0_25px_50px_-12px_rgba(0,0,0,0.15)]">
                <img
                  src="/about-bg.webp"
                  alt="About Portauto"
              ...
              <div className="flex flex-col justify-center gap-6">
                <a href="#" className="w-14 h-14 bg-blue-500 rounded-full flex items-center justify-center hover:bg-blue-600 transition-colors">
                  <TelegramIcon className="w-7 h-7 text-white" />
                </a>
                <a href="#" className="w-14 h-14 bg-green-500 rounded-full flex items-center justify-center hover:bg-green-600 transition-colors">
                  <WhatsAppIcon className="w-7 h-7 text-white" />
                </a>
                <a href="#" className="w-14 h-14 bg-blue-700 rounded-full flex items-center justify-center hover:bg-blue-800 transition-colors">
